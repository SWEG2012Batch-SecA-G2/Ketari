  ...
  <body>
    ...
    <header>
      ...
      <div id="intro">
        ...
        <p>
          ...
          molestias rem voluptatem sint! Quisquam vitae minus beatae aperiam,
          corrupti, dolores obcaecati, fugiat quia perferendis harum autem
          repellendus magnam. Consequuntur, repudiandae.
        </p>
      </div>
      <!-- Banner Image -->
      <div>
    ...
    <body>
      <div class="body-wrapper">
        ...
        <form action="jobs.php" name="myForm" onsubmit="return validate()" >
          <div>
          ...
          <button class="form-save" type="submit" onclick="storeForm()">SAVE</button>
        </form>
      </div>
    </body>
